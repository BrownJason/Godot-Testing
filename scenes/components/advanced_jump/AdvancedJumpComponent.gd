...
func handle_jump(body: CharacterBody2D, want_to_jump: bool, jump_released: bool):
...
func handled_coyote_timer(body: CharacterBody2D):
...
func handle_variable_jump(body: CharacterBody2D, jump_released: bool):
